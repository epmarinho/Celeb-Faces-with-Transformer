...
import warnings
# Ignore the specific warning related to self_attn.batch_first
...
def initialize_weights(model, model_checkpoint="trained_cnn_model.pth"):
    for module in model.modules():
        if isinstance(module, (nn.Conv2d, nn.Linear)):
            ...
            module.self_attn.batch_first = True  # Set batch_first to True
...
cnn_out_dims = [16, 32, 64, 128] # List of output dimensions for convolutional layers
